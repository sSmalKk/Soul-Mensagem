...
/// This class defines the variables used in the [create_mensage_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class CreateMensageModel extends Equatable {
  CreateMensageModel({
